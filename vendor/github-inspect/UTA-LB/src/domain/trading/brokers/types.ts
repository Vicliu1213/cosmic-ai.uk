 ...
 *
 * All broker implementations (Alpaca, CCXT, IBKR, Longbridge, ...) implement IBroker.
...
export interface IBroker<TMeta = unknown> {
  /** Unique account ID, e.g. "alpaca-paper", "bybit-main", "longbridge-live". */
  readonly id: string
   ...
   *  Each broker defines its own uniqueness: Alpaca = ticker, CCXT = unified symbol, IBKR = conId, Longbridge = symbol (700.HK). */
