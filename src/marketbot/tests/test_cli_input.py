...
from marketbot.cli import commands
...
def mock_prompt_session():
    ...
    with patch("marketbot.cli.commands._PROMPT_SESSION", mock_session), \
         patch("marketbot.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("marketbot.cli.commands.PromptSession") as MockSession, \
         patch("marketbot.cli.commands.FileHistory") as MockHistory, \
