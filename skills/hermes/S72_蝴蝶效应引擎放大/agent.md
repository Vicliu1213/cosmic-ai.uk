---
name: S72-蝴蝶效应引擎放大
description: 用极小行动撬动极大结果，放大倍数10^3到10^9
license: MIT
compatibility: opencode
metadata:
  category: 意识精神
  hero_code: BUTTERFLY-ENGINE-10-9
  substrate: temporal
...
- 激活技能 **蝴蝶效应引擎放大**（BUTTERFLY-ENGINE-10-9）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S37, S69] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **蝴蝶效应引擎放大** 时调用此 agent。
...
3. **协同验证**：验证与 [S37, S69] 的协同激活是否产生预期的
