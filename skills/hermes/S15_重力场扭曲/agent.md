---
name: S15-重力场扭曲
description: 在指定区域产生0到1000倍重力场
license: MIT
compatibility: opencode
metadata:
  category: 战斗异能
  hero_code: GRAVITY-DISTORTION
  ...
  range_meters: 500
  duration_seconds: 30
  power_watts: 4.40e+16
  synergy_with: S11, S36
...
- 激活技能 **重力场扭曲**（GRAVITY-DISTORTION）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S11, S36] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **重力场扭曲** 时调用此 agent。
...
3. **协同验证**：验证与 [S11, S36] 的协同激活是否产生预期的
