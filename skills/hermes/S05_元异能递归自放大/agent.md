---
name: S05-元异能递归自放大
description: 神经系统进入递归自增强循环
license: MIT
compatibility: opencode
metadata:
  category: 战斗异能
  hero_code: NEURAL-RED-PROTOCOL
  substrate: neural
  workflow: combat
  energy_cost: 950
  cooldown_seconds: 0
...
- 激活技能 **元异能递归自放大**（NEURAL-RED-PROTOCOL）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S02, S87] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **元异能递归自放大** 时调用此 agent。
...
3. **协同验证**：验证与 [S02, S87] 的协同激活是否产生预期的
