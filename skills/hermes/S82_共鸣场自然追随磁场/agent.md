---
name: S82-共鸣场自然追随磁场
description: 在10000公里内创造吸引力场
license: MIT
compatibility: opencode
metadata:
  category: 资本影响
  hero_code: RESONANCE-FIELD-ATTRACTOR
  substrate: cosmic
  workflow: capital
  energy_cost: 300
  cooldown_seconds: 0
...
- 激活技能 **共鸣场自然追随磁场**（RESONANCE-FIELD-ATTRACTOR）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S81, S73] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **共鸣场自然追随磁场** 时调用此 agent。
...
3. **协同验证**：验证与 [S81, S73] 的协同激活是否产生预期的
