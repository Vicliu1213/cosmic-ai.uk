---
name: S22-思维编译器念即成真
description: 将抽象思想直接编译为可执行的物理操作指令
license: MIT
compatibility: opencode
metadata:
  category: 神经增强
  hero_code: THOUGHT-COMPILER-ZERO
  substrate: neural
  workflow: neural
  energy_cost: 500
  cooldown_seconds: 0
...
- 激活技能 **思维编译器念即成真**（THOUGHT-COMPILER-ZERO）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S19, S40] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **思维编译器念即成真** 时调用此 agent。
...
3. **协同验证**：验证与 [S19, S40] 的协同激活是否产生预期的
