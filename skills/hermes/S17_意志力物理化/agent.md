---
name: S17-意志力物理化
description: 将意志力转化为物理力量
license: MIT
compatibility: opencode
metadata:
  category: 战斗异能
  hero_code: WILLPOWER-MATERIALIZATION
  substrate: cosmic
  workflow: combat
  energy_cost: 1200
  cooldown_seconds: 30
  range_meters: 100
  duration_seconds: 60
  power_watts: 7.70e+17
  synergy_with: S90, S96
...
- 激活技能 **意志力物理化**（WILLPOWER-MATERIALIZATION）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S90, S96] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **意志力物理化** 时调用此 agent。
...
3. **协同验证**：验证与 [S90, S96] 的协同激活是否产生预期的
