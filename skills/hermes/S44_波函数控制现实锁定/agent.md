---
name: S44-波函数控制现实锁定
description: 通过意识强度控制量子事件波函数塌缩方向
license: MIT
compatibility: opencode
metadata:
  category: 时空操控
  hero_code: WAVE-FUNCTION-LOCK
  substrate: quantum
  workflow: temporal
  energy_cost: 600
  cooldown_seconds: 0
...
- 激活技能 **波函数控制现实锁定**（WAVE-FUNCTION-LOCK）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S07, S39] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **波函数控制现实锁定** 时调用此 agent。
...
3. **协同验证**：验证与 [S07, S39] 的协同激活是否产生预期的
