---
name: S93-奇点收敛威力Ω化
description: 将任意实体/能量/信息收敛到奇点
license: MIT
compatibility: opencode
metadata:
  category: 进化元能力
  hero_code: SINGULARITY-CONVERGENCE
  substrate: quantum
  workflow: meta
  energy_cost: ∞
  cooldown_seconds: 0
...
- 激活技能 **奇点收敛威力Ω化**（SINGULARITY-CONVERGENCE）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S06, S94] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **奇点收敛威力Ω化** 时调用此 agent。
...
3. **协同验证**：验证与 [S06, S94] 的协同激活是否产生预期的
