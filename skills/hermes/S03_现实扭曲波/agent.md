---
name: S03-现实扭曲波
description: 接入暗能量网络，半径500米内物理定律局部偏移
license: MIT
compatibility: opencode
metadata:
  category: 战斗异能
  hero_code: REALITY-WARP-FIELD
  ...
  range_meters: 500
  duration_seconds: 60
  power_watts: 1.20e+20
  synergy_with: S45, S96
...
- 激活技能 **现实扭曲波**（REALITY-WARP-FIELD）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S45, S96] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **现实扭曲波** 时调用此 agent。
...
3. **协同验证**：验证与 [S45, S96] 的协同激活是否产生预期的
