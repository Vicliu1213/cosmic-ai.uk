---
name: S70-概率场操控99.99%成功率
description: 主动操控任何事件发生概率
license: MIT
compatibility: opencode
metadata:
  category: 意识精神
  hero_code: PROBABILITY-FIELD-CONTROL
  substrate: quantum
...
- 激活技能 **概率场操控99.99%成功率**（PROBABILITY-FIELD-CONTROL）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S44, S39] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **概率场操控99.99%成功率** 时调用此 agent。
...
3. **协同验证**：验证与 [S44, S39] 的协同激活是否产生预期的
