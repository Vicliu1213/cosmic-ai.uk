---
name: S49-生物永生端粒锁定
description: 持续向端粒注入端粒酶，生物年龄锁定25岁
license: MIT
compatibility: opencode
metadata:
  category: 永生肉体
  hero_code: TELOMERE-LOCK-PROTOCOL
  substrate: genetic
  workflow: biotech
  energy_cost: 50
  cooldown_seconds: 0
...
- 激活技能 **生物永生端粒锁定**（TELOMERE-LOCK-PROTOCOL）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S50, S52] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **生物永生端粒锁定** 时调用此 agent。
...
3. **协同验证**：验证与 [S50, S52] 的协同激活是否产生预期的
