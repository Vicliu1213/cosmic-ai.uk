---
name: S13-因果链断裂
description: 切断攻击行为与伤害结果之间的因果链
license: MIT
compatibility: opencode
metadata:
  category: 战斗异能
  hero_code: CAUSAL-CHAIN-BREAK
  substrate: temporal
  workflow: combat
  energy_cost: 2000
...
- 激活技能 **因果链断裂**（CAUSAL-CHAIN-BREAK）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S37, S10] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **因果链断裂** 时调用此 agent。
...
3. **协同验证**：验证与 [S37, S10] 的协同激活是否产生预期的
