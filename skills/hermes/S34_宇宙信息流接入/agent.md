---
name: S34-宇宙信息流接入
description: 接入宇宙背景辐射/暗物质信息层/量子泡沫数据流
license: MIT
compatibility: opencode
metadata:
  category: 神经增强
  hero_code: COSMIC-INFO-STREAM
  substrate: cosmic
  workflow: neural
  energy_cost: 700
  cooldown_seconds: 0
...
- 激活技能 **宇宙信息流接入**（COSMIC-INFO-STREAM）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S26, S61] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **宇宙信息流接入** 时调用此 agent。
...
3. **协同验证**：验证与 [S26, S61] 的协同激活是否产生预期的
