---
name: S26-阿卡西记录宇宙全史
description: 访问宇宙138亿年历史的完整信息
license: MIT
compatibility: opencode
metadata:
  category: 神经增强
  hero_code: AKASHIC-RECORDS-ACCESS
  substrate: cosmic
  workflow: neural
  energy_cost: 800
  cooldown_seconds: 0
...
- 激活技能 **阿卡西记录宇宙全史**（AKASHIC-RECORDS-ACCESS）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S61, S34] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **阿卡西记录宇宙全史** 时调用此 agent。
...
3. **协同验证**：验证与 [S61, S34] 的协同激活是否产生预期的
