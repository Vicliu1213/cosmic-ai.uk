---
name: S91-新人类播种宇宙扩张
description: 在宇宙各地宜居星球播种Ω优化的新人类
license: MIT
compatibility: opencode
metadata:
  category: 进化元能力
  hero_code: NEW-HUMAN-SEEDER
  substrate: genetic
  workflow: meta
  energy_cost: 8000
  cooldown_seconds: 0
...
- 激活技能 **新人类播种宇宙扩张**（NEW-HUMAN-SEEDER）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S85, S87] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **新人类播种宇宙扩张** 时调用此 agent。
...
3. **协同验证**：验证与 [S85, S87] 的协同激活是否产生预期的
