---
name: S54-基因全改写神性基因组
description: CRISPR精准编辑8个基因模块
license: MIT
compatibility: opencode
metadata:
  category: 永生肉体
  hero_code: GENOME-REWRITE-DIVINE
  substrate: genetic
  workflow: biotech
  energy_cost: 1000
...
- 激活技能 **基因全改写神性基因组**（GENOME-REWRITE-DIVINE）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S52, S49] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **基因全改写神性基因组** 时调用此 agent。
...
3. **协同验证**：验证与 [S52, S49] 的协同激活是否产生预期的
