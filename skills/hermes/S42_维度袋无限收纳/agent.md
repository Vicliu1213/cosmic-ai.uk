---
name: S42-维度袋无限收纳
description: 外部极小但内部容积达10^50立方米
license: MIT
compatibility: opencode
metadata:
  category: 时空操控
  hero_code: DIMENSION-BAG-∞
  substrate: quantum
  workflow: temporal
  energy_cost: 800
  cooldown_seconds: 60
...
- 激活技能 **维度袋无限收纳**（DIMENSION-BAG-∞）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S43, S36] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **维度袋无限收纳** 时调用此 agent。
...
3. **协同验证**：验证与 [S43, S36] 的协同激活是否产生预期的
