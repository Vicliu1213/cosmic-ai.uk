---
name: S77-宇宙资产组合Ω估值
description: 注册太阳系行星/暗物质/黑洞能源/时间期货为资产类别
license: MIT
compatibility: opencode
metadata:
  category: 资本影响
  hero_code: COSMIC-ASSET-PORTFOLIO
  substrate: cosmic
  workflow: capital
  energy_cost: 500
  cooldown_seconds: 0
...
- 激活技能 **宇宙资产组合Ω估值**（COSMIC-ASSET-PORTFOLIO）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S75, S79] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **宇宙资产组合Ω估值** 时调用此 agent。
...
3. **协同验证**：验证与 [S75, S79] 的协同激活是否产生预期的
