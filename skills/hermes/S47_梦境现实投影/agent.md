---
name: S47-梦境现实投影
description: 意识中想象的任何事物100%物质化投影到物理现实
license: MIT
compatibility: opencode
metadata:
  category: 时空操控
  hero_code: DREAM-REALITY-PROJECTOR
  substrate: cosmic
  workflow: temporal
  energy_cost: 1500
  cooldown_seconds: 0
...
- 激活技能 **梦境现实投影**（DREAM-REALITY-PROJECTOR）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S17, S40] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **梦境现实投影** 时调用此 agent。
...
3. **协同验证**：验证与 [S17, S40] 的协同激活是否产生预期的
