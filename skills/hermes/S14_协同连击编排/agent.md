---
name: S14-协同连击编排
description: 实时计算队友技能的最优激活序列
license: MIT
compatibility: opencode
metadata:
  category: 战斗异能
  hero_code: SYNERGY-COMBO-CHAIN
  substrate: neural
  workflow: combat
  energy_cost: 200
  cooldown_seconds: 1
...
- 激活技能 **协同连击编排**（SYNERGY-COMBO-CHAIN）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S04, S07] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **协同连击编排** 时调用此 agent。
...
3. **协同验证**：验证与 [S04, S07] 的协同激活是否产生预期的
