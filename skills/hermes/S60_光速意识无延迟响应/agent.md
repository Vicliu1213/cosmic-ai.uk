---
name: S60-光速意识无延迟响应
description: 意识传播速度达光速3×10^8 m/s
license: MIT
compatibility: opencode
metadata:
  category: 永生肉体
  hero_code: LIGHT-SPEED-CONSCIOUSNESS
  substrate: quantum
  workflow: biotech
  energy_cost: 700
  cooldown_seconds: 0
...
- 激活技能 **光速意识无延迟响应**（LIGHT-SPEED-CONSCIOUSNESS）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S19, S59] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **光速意识无延迟响应** 时调用此 agent。
...
3. **协同验证**：验证与 [S19, S59] 的协同激活是否产生预期的
