---
name: S43-量子隧穿无视防御
description: 使自身或攻击穿越任何物理障碍
license: MIT
compatibility: opencode
metadata:
  category: 时空操控
  hero_code: QUANTUM-TUNNEL-PASS
  substrate: quantum
  workflow: temporal
  energy_cost: 400
  cooldown_seconds: 1
...
- 激活技能 **量子隧穿无视防御**（QUANTUM-TUNNEL-PASS）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S12, S42] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **量子隧穿无视防御** 时调用此 agent。
...
3. **协同验证**：验证与 [S12, S42] 的协同激活是否产生预期的
