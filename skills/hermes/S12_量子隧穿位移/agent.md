---
name: S12-量子隧穿位移
description: 利用量子隧穿效应穿越任何物理障碍
license: MIT
compatibility: opencode
metadata:
  category: 战斗异能
  hero_code: QUANTUM-TUNNEL-DASH
  substrate: quantum
  workflow: combat
  energy_cost: 400
  cooldown_seconds: 2
...
- 激活技能 **量子隧穿位移**（QUANTUM-TUNNEL-DASH）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S01, S44] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **量子隧穿位移** 时调用此 agent。
...
3. **协同验证**：验证与 [S01, S44] 的协同激活是否产生预期的
