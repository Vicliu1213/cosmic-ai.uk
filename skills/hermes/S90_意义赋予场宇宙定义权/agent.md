---
name: S90-意义赋予场宇宙定义权
description: 为宇宙中任何事物定义其存在意义
license: MIT
compatibility: opencode
metadata:
  category: 进化元能力
  hero_code: MEANING-FIELD-COSMIC
  substrate: cosmic
  workflow: meta
  energy_cost: 2000
  cooldown_seconds: 0
...
- 激活技能 **意义赋予场宇宙定义权**（MEANING-FIELD-COSMIC）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S88, S64] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **意义赋予场宇宙定义权** 时调用此 agent。
...
3. **协同验证**：验证与 [S88, S64] 的协同激活是否产生预期的
