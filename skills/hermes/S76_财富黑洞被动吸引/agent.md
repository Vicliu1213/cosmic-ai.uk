---
name: S76-财富黑洞被动吸引
description: 暗能量配置为经济引力场，100公里内资本流动系统性偏向
license: MIT
compatibility: opencode
metadata:
  category: 资本影响
  hero_code: ECONOMIC-GRAVITY-FIELD
...
- 激活技能 **财富黑洞被动吸引**（ECONOMIC-GRAVITY-FIELD）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S75, S73] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **财富黑洞被动吸引** 时调用此 agent。
...
3. **协同验证**：验证与 [S75, S73] 的协同激活是否产生预期的
