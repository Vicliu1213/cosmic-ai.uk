---
name: S20-万路并行思维
description: 前额叶皮层划分为1024个半独立处理单元
license: MIT
compatibility: opencode
metadata:
  category: 神经增强
  hero_code: CORTEX-FORK-1024
  substrate: neural
  workflow: neural
  energy_cost: 180
  cooldown_seconds: 0
...
- 激活技能 **万路并行思维**（CORTEX-FORK-1024）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S19, S32] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **万路并行思维** 时调用此 agent。
...
3. **协同验证**：验证与 [S19, S32] 的协同激活是否产生预期的
