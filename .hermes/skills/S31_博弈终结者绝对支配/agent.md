---
name: S31-博弈终结者绝对支配
description: 在任何博弈中找到绝对支配策略
license: MIT
compatibility: opencode
metadata:
  category: 神经增强
  hero_code: GAME-THEORY-DOMINATOR
  substrate: neural
  workflow: neural
  energy_cost: 350
  cooldown_seconds: 0
...
- 激活技能 **博弈终结者绝对支配**（GAME-THEORY-DOMINATOR）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S24, S81] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **博弈终结者绝对支配** 时调用此 agent。
...
3. **协同验证**：验证与 [S24, S81] 的协同激活是否产生预期的
