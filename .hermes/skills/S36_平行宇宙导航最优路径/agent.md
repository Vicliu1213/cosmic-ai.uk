---
name: S36-平行宇宙导航最优路径
description: 嗅探最近平行分支，感知其中的决策结果
license: MIT
compatibility: opencode
metadata:
  category: 时空操控
  hero_code: MWI-NAVIGATOR
  substrate: quantum
  workflow: temporal
  energy_cost: 1200
...
- 激活技能 **平行宇宙导航最优路径**（MWI-NAVIGATOR）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S37, S24] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **平行宇宙导航最优路径** 时调用此 agent。
...
3. **协同验证**：验证与 [S37, S24] 的协同激活是否产生预期的
