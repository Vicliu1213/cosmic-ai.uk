---
name: S58-体内核聚变无限自持
description: 每个细胞内建微型核聚变反应堆
license: MIT
compatibility: opencode
metadata:
  category: 永生肉体
  hero_code: INTERNAL-FUSION-REACTOR
  substrate: genetic
  workflow: biotech
  energy_cost: 2000
  cooldown_seconds: 0
  range_meters: 0
  duration_seconds: ∞
  power_watts: 3.80e+26
  synergy_with: S52, S57
...
- 激活技能 **体内核聚变无限自持**（INTERNAL-FUSION-REACTOR）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S52, S57] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **体内核聚变无限自持** 时调用此 agent。
...
3. **协同验证**：验证与 [S52, S57] 的协同激活是否产生预期的
