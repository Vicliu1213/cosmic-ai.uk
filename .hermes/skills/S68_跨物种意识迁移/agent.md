---
name: S68-跨物种意识迁移
description: 暂时进入任何生物的意识视角
license: MIT
compatibility: opencode
metadata:
  category: 意识精神
  hero_code: CROSS-SPECIES-CONSCIOUSNESS
  substrate: neural
...
- 激活技能 **跨物种意识迁移**（CROSS-SPECIES-CONSCIOUSNESS）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S59, S67] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **跨物种意识迁移** 时调用此 agent。
...
3. **协同验证**：验证与 [S59, S67] 的协同激活是否产生预期的
