---
name: S21-集体意识接入涌现智慧
description: 10个以上激活者同步形成临时集体意识
license: MIT
compatibility: opencode
metadata:
  category: 神经增强
  hero_code: MESHLINK-COLLECTIVE
...
- 激活技能 **集体意识接入涌现智慧**（MESHLINK-COLLECTIVE）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S04, S63] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **集体意识接入涌现智慧** 时调用此 agent。
...
3. **协同验证**：验证与 [S04, S63] 的协同激活是否产生预期的
