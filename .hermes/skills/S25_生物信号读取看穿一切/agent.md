---
name: S25-生物信号读取看穿一切
description: 读取任何人的情绪/意图/健康状态
license: MIT
compatibility: opencode
metadata:
  category: 神经增强
  hero_code: BIOSIGNAL-READER-PRO
...
- 激活技能 **生物信号读取看穿一切**（BIOSIGNAL-READER-PRO）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S08, S16] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **生物信号读取看穿一切** 时调用此 agent。
...
3. **协同验证**：验证与 [S08, S16] 的协同激活是否产生预期的
