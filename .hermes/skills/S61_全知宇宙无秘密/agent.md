---
name: S61-全知宇宙无秘密
description: 神经系统与全球150亿IoT传感器节点同步
license: MIT
compatibility: opencode
metadata:
  category: 意识精神
  hero_code: GLOBAL-SENSOR-NEURAL
  substrate: bioelectric
  workflow: consciousness
  energy_cost: 500
  cooldown_seconds: 0
  range_meters: 6.371e+06
  duration_seconds: ∞
  power_watts: 0
  synergy_with: S34, S26
...
- 激活技能 **全知宇宙无秘密**（GLOBAL-SENSOR-NEURAL）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S34, S26] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **全知宇宙无秘密** 时调用此 agent。
...
3. **协同验证**：验证与 [S34, S26] 的协同激活是否产生预期的
