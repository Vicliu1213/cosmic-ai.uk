---
name: S87-元进化进化的进化
description: 修改自己的基因组，每次使用成为稍微不同的物种
license: MIT
compatibility: opencode
metadata:
  category: 进化元能力
  hero_code: META-EVOLUTION-SRP-∞
  substrate: genetic
  workflow: meta
  energy_cost: 2000
...
- 激活技能 **元进化进化的进化**（META-EVOLUTION-SRP-∞）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S02, S88] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **元进化进化的进化** 时调用此 agent。
...
3. **协同验证**：验证与 [S02, S88] 的协同激活是否产生预期的
