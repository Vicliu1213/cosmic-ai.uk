---
name: S92-物种进化广播全球信号
description: 向全人类80亿人广播进化信号，接收率30-60%
license: MIT
compatibility: opencode
metadata:
  category: 进化元能力
  hero_code: SPECIES-EVOLUTION-BROADCAST
  substrate: memetic
  workflow: meta
  energy_cost: 3000
  cooldown_seconds: 0
...
- 激活技能 **物种进化广播全球信号**（SPECIES-EVOLUTION-BROADCAST）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S86, S91] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **物种进化广播全球信号** 时调用此 agent。
...
3. **协同验证**：验证与 [S86, S91] 的协同激活是否产生预期的
