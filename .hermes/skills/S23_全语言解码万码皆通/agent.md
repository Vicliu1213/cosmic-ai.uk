---
name: S23-全语言解码万码皆通
description: 解码9999种以上语言包括量子信息编码
license: MIT
compatibility: opencode
metadata:
  category: 神经增强
  hero_code: OMNI-DECODE-9999
  substrate: neural
  workflow: neural
  energy_cost: 100
  cooldown_seconds: 0
...
- 激活技能 **全语言解码万码皆通**（OMNI-DECODE-9999）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S24, S61] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **全语言解码万码皆通** 时调用此 agent。
...
3. **协同验证**：验证与 [S24, S61] 的协同激活是否产生预期的
