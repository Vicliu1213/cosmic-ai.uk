---
name: S56-器官超人类升级
description: 全器官替换升级：大脑量子处理器等
license: MIT
compatibility: opencode
metadata:
  category: 永生肉体
  hero_code: ORGAN-SUPERHUMAN-UPGRADE
  substrate: nanobot
  workflow: biotech
  energy_cost: 3000
  cooldown_seconds: 0
...
- 激活技能 **器官超人类升级**（ORGAN-SUPERHUMAN-UPGRADE）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S55, S59] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **器官超人类升级** 时调用此 agent。
...
3. **协同验证**：验证与 [S55, S59] 的协同激活是否产生预期的
