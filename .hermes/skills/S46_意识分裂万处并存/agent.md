---
name: S46-意识分裂万处并存
description: 意识分裂为10000份完整独立碎片
license: MIT
compatibility: opencode
metadata:
  category: 时空操控
  hero_code: CONSCIOUSNESS-SPLIT-10K
  substrate: quantum
  workflow: temporal
  energy_cost: 1000
...
- 激活技能 **意识分裂万处并存**（CONSCIOUSNESS-SPLIT-10K）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S63, S47] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **意识分裂万处并存** 时调用此 agent。
...
3. **协同验证**：验证与 [S63, S47] 的协同激活是否产生预期的
