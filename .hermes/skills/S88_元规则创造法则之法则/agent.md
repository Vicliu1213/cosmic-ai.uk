---
name: S88-元规则创造法则之法则
description: 创造管理规则的元规则
license: MIT
compatibility: opencode
metadata:
  category: 进化元能力
  hero_code: META-RULE-CREATOR
  substrate: cosmic
  workflow: meta
  energy_cost: 3000
  cooldown_seconds: 0
...
- 激活技能 **元规则创造法则之法则**（META-RULE-CREATOR）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S87, S89] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **元规则创造法则之法则** 时调用此 agent。
...
3. **协同验证**：验证与 [S87, S89] 的协同激活是否产生预期的
