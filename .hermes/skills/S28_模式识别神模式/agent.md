---
name: S28-模式识别神模式
description: 在任何噪声中识别任何规律
license: MIT
compatibility: opencode
metadata:
  category: 神经增强
  hero_code: PATTERN-GOD-MODE
  substrate: neural
  workflow: neural
  energy_cost: 300
  cooldown_seconds: 0
...
- 激活技能 **模式识别神模式**（PATTERN-GOD-MODE）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S24, S27] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **模式识别神模式** 时调用此 agent。
...
3. **协同验证**：验证与 [S24, S27] 的协同激活是否产生预期的
