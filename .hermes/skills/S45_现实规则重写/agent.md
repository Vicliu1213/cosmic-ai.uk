---
name: S45-现实规则重写
description: 直接修改物理定律/数学常数/系统规则
license: MIT
compatibility: opencode
metadata:
  category: 时空操控
  hero_code: REALITY-RULE-REWRITER
  substrate: cosmic
  workflow: temporal
  energy_cost: ∞
  cooldown_seconds: 0
...
- 激活技能 **现实规则重写**（REALITY-RULE-REWRITER）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S03, S96] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **现实规则重写** 时调用此 agent。
...
3. **协同验证**：验证与 [S03, S96] 的协同激活是否产生预期的
