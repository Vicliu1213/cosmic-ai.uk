---
name: S59-多维感官8感扩展
description: 新增量子感知/时间感知/电磁感知等8感
license: MIT
compatibility: opencode
metadata:
  category: 永生肉体
  hero_code: MULTISENSE-8D-EXPANSION
  substrate: genetic
  workflow: biotech
  energy_cost: 600
  cooldown_seconds: 0
...
- 激活技能 **多维感官8感扩展**（MULTISENSE-8D-EXPANSION）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S56, S25] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **多维感官8感扩展** 时调用此 agent。
...
3. **协同验证**：验证与 [S56, S25] 的协同激活是否产生预期的
