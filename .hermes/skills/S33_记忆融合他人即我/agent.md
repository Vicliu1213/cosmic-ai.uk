---
name: S33-记忆融合他人即我
description: 直接融合他人技能记忆，95%融合率
license: MIT
compatibility: opencode
metadata:
  category: 神经增强
  hero_code: MEMORY-FUSION-PROTOCOL
  substrate: neural
  workflow: neural
  energy_cost: 400
  cooldown_seconds: 0
...
- 激活技能 **记忆融合他人即我**（MEMORY-FUSION-PROTOCOL）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S21, S32] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **记忆融合他人即我** 时调用此 agent。
...
3. **协同验证**：验证与 [S21, S32] 的协同激活是否产生预期的
