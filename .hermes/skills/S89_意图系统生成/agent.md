---
name: S89-意图系统生成
description: 从一个纯粹意图出发瞬时生成完整可运行系统
license: MIT
compatibility: opencode
metadata:
  category: 进化元能力
  hero_code: INTENTION-TO-SYSTEM
  substrate: cosmic
  workflow: meta
  energy_cost: 1000
  cooldown_seconds: 0
...
- 激活技能 **意图系统生成**（INTENTION-TO-SYSTEM）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S22, S88] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **意图系统生成** 时调用此 agent。
...
3. **协同验证**：验证与 [S22, S88] 的协同激活是否产生预期的
