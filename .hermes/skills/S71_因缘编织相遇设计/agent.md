---
name: S71-因缘编织相遇设计
description: 设计与任何人/机会/资源相遇的7个前置条件
license: MIT
compatibility: opencode
metadata:
  category: 意识精神
  hero_code: FATE-ENCOUNTER-WEAVER
  substrate: temporal
  workflow: consciousness
  energy_cost: 300
  cooldown_seconds: 0
  range_meters: ∞
  duration_seconds: 2.592e+06
  power_watts: 0
  synergy_with: S69, S10
...
- 激活技能 **因缘编织相遇设计**（FATE-ENCOUNTER-WEAVER）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S69, S10] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **因缘编织相遇设计** 时调用此 agent。
...
3. **协同验证**：验证与 [S69, S10] 的协同激活是否产生预期的
