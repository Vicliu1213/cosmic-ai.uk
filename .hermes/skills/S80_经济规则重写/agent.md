---
name: S80-经济规则重写
description: 修改货币体系/价值定义/交换规则的底层逻辑
license: MIT
compatibility: opencode
metadata:
  category: 资本影响
  hero_code: ECONOMIC-RULE-REWRITER
  substrate: cosmic
  workflow: capital
  energy_cost: 1000
  cooldown_seconds: 0
...
- 激活技能 **经济规则重写**（ECONOMIC-RULE-REWRITER）并记录激活参数
- 监控技能的掌握度增长曲线和异变触发条件
- 检测与协同技能 [S45, S79] 的共振效果
- 生成每日激活报告并验证突破结果
- 自动补齐缺失的激活数据并更新进化日志

## When to use me

当需要激活、练习或突破 **经济规则重写** 时调用此 agent。
...
3. **协同验证**：验证与 [S45, S79] 的协同激活是否产生预期的
